...
public class AmazonFeed extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_amazon_feed, container, false);
        RecyclerView recyclerView = view.findViewById(R.id.appDrawerView);
        AppLauncherAdapter appLauncherAdapter = new AppLauncherAdapter(this.getActivity());
